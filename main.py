...
# Monkey-patch for Windows: treat PosixPath as WindowsPath
if os.name == "nt":
...
app.add_middleware(
    CORSMiddleware,  # Allows communication with frontend applications
...
def video_feed_generator(video_path="video/IMG_6358.MOV"):
    ...
    while True:
        ...
        #Encoding Frames to JPEG for Streaming
    ...
    cap.release()
#Converts frames into MJPEG format for real-time streaming.
@app.get("/video_feed")
def video_feed():
